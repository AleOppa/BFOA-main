...
numeroDeBacterias = 9  #3 numero original dado por el profesor
numRandomBacteria = 3 #  1 numero original dado por el profesor  -  aumentar numero random de bacterias para diversidad
iteraciones = 25   #30 numero original - reducir ciclos para menos NFE
tumbo = 1          #1 numero original                                 #numero de gaps a insertar 
nado = 2            #2 numero original
chemio = chemiotaxis()
...
dAttr= 0.1 #0.1 numeros originales de autor pacino
wAttr= 0.2 #0.2 numeros originales de autor pacino
hRep=dAttr
wRep= 10 #10 numeros originales de autor pacino
